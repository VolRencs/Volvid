...
var strEN = UIStrings{
	...
	FragmentInputPrompt: "Format: start-end, start-, or start+",
	FragmentInputHint:   "Example: 1:00-2:30 or 1:00-", FragmentInputHintWithDurationFmt: "Example: 1:00-2:30 or 1:00-\nVideo duration: %s\nEnd cannot exceed the video duration.",
...
var strRU = UIStrings{
	...
	FragmentInputPrompt: "Формат: начало-конец, начало- или начало+",
	FragmentInputHint:   "Пример: 1:00-2:30 или 1:00-", FragmentInputHintWithDurationFmt: "Пример: 1:00-2:30 или 1:00-\nДлительность видео: %s\nКонец диапазона не должен выходить за длительность видео.",
...
func PlaylistSuffix(l core.Locale, n int) string {
	if n <= 0 {
		return ""
	}
